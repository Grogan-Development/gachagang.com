        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-12">
            <div>
              ...
              <Text as="h2">FEATURED PRODUCTS</Text>
            </div>
      ...
      <section className="py-16 md:py-24 bg-card border-y-4 border-foreground">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <Text as="h2">SHOP BY CATEGORY</Text>
          </div>

          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
            {["apparel", "collectibles", "accessories", "art", "home"].map((category) => (
              <Link
                key={category}
                href={`/shop?category=${category}`}
                className="group p-6 bg-background border-2 border-foreground rounded shadow-md hover:shadow-none hover:translate-y-1 transition-all text-center"
              >
                ...
                <Text as="h4" className="font-medium group-hover:text-primary transition-colors capitalize">
                  {category}
                </Text>
              </Link>
            ))}
